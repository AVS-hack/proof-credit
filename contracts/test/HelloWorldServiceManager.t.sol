...
import {ProofOfCreditScore} from "../src/ProofOfCreditScore.sol";
...
import {IProofOfCreditScore} from "../src/IProofOfCreditScore.sol";
...
contract HelloWorldTaskManagerSetup is Test {
    ...
    // ) internal {
    //     IProofOfCreditScore helloWorldServiceManager = IProofOfCreditScore(
    //         helloWorldDeployment.helloWorldServiceManager
    //     );
    ...
    //     Operator memory operator,
    //     IProofOfCreditScore.Task memory task,
    ...
    //     IProofOfCreditScore(helloWorldDeployment.helloWorldServiceManager)
...
contract RegisterOperator is HelloWorldTaskManagerSetup {
    ...
    IProofOfCreditScore internal sm;
...
contract CreateTask is HelloWorldTaskManagerSetup {
    ...
    //     vm.prank(generator.key.addr);
    //     IProofOfCreditScore.Task memory newTask = sm.createNewTask(
    //         taskName
    //     );
    // }
}
